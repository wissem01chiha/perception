...
with open('robotics-perception/_version.py', 'r') as version_file:
...
setuptools.setup(
    name='ROBOTICS_PERCEPTION',
    version=version,
    description='Your project description here',
    long_description=long_description,
    long_description_content_type="text/markdown",
    url='https://github.com/wissem01chiha/robotics-perception',
    author='USERNAME',
    license='MIT',
    ...
    entry_points={
        'console_scripts': [
            'ROBOTICS_PERCEPTION=project_name.my_module:main',
        ]
    },
