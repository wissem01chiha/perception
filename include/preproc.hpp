...
//
// - Murali, Saritha, and V. K. Govindan. "Removal of shadows from a single image." 
...
void removeShadows(cv::Mat image,
                    int ab_threshold,
                    bool lab_adjustment,
                    int region_adjustment_kernel_size,
                    int shadow_dilation_iteration,
                    int shadow_dilation_kernel_size,
                    int shadow_size_threshold,
                    bool verbose){
